from endless_2020.constants import DAYS_IN_DECEMBER, DEFAULT_FORMAT, END_OF_2020
...
def strftime(input_date: datetime, fmt: str = DEFAULT_FORMAT) -> str:
